...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Grow - Order Phone",
  "categories": ["ATTRIBUTION", "MARKETING", "PERSONALIZATION", "REMARKETING", "CONVERSIONS"],
  "description": "Captures the phone used in an order from the data layer",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "phone",
    "displayName": "Order Phone - Required",
...
scenarios:
- name: Returns phone from DL by given name
  code: |-
    const mockData = {
      phone: 'telephone'
    };
    ...
    assertThat(res).isEqualTo('5569999999999');


___NOTES___

Created on 11/04/2024, 14:10:09
